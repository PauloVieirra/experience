export default function DislexiaContent() {
  return (
    <div className="space-y-8">
      <header className="border-b-2 border-orange-200 pb-6">
      ...
      <section className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Fontes Amigáveis</h3>
            <p className="text-green-800 text-sm">Usamos fontes sans-serif que são mais fáceis de ler. Opções como OpenDyslexic são projetadas especificamente para isso.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Espaçamento Generoso</h3>
            <p className="text-green-800 text-sm">Aumentamos o espaço entre linhas e letras para ajudar a diferenciar as palavras e palavras.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Linhas Curtas</h3>
            <p className="text-green-800 text-sm">O texto é apresentado em colunas mais estreitas, tornando a quebra de linha mais previsível.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Alinhamento à Esquerda</h3>
            <p className="text-green-800 text-sm">O texto alinhado à esquerda cria uma margem irregular à direita, servindo como ponto de referência visual.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded col-span-2">
            <h3 className="font-bold text-green-900 mb-2">Estrutura Clara</h3>
            <p className="text-green-800 text-sm">Títulos, listas e parágrafos curtos quebram o conteúdo em pedaços gerenciáveis, facilitando a compreensão.</p>
          </div>
        </div>
      </section>
