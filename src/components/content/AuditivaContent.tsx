export default function AuditivaContent() {
  return (
    <div className="space-y-10">
      <header className="border-b-2 border-teal-200 pb-8">
      ...
      <section className="space-y-5">
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Legendas (Closed Captions)</h3>
            <p className="text-green-800 text-sm leading-relaxed">Vídeos são exibidos com legendas sincronizadas que incluem sons importantes e descrições de áudio.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Transcrições Completas</h3>
            <p className="text-green-800 text-sm leading-relaxed">Para conteúdo de áudio, fornecemos uma transcrição textual completa e acessível.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Língua de Sinais</h3>
            <p className="text-green-800 text-sm leading-relaxed">Inclusão de intérprete de Língua Brasileira de Sinais (Libras) quando relevante.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Descrição de Áudio</h3>
            <p className="text-green-800 text-sm leading-relaxed">Narração que descreve elementos visuais importantes não transmitidos pelo áudio original.</p>
          </div>
        </div>
      </section>
