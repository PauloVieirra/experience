      ...
      <section className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            ...
            <p className="text-green-800 text-sm">O conteúdo principal é apresentado em uma coluna estreita no centro da tela, minimizando a necessidade de mover os olhos.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Ordem de Leitura Lógica</h3>
            <p className="text-green-800 text-sm">A informação é estruturada de forma linear e previsível, sem surpresas nas laterais da página.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Foco Visível e Proeminente</h3>
            <p className="text-green-800 text-sm">Um indicador de foco claro ajuda na navegação por teclado e mostra onde o usuário está na página.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Sem Conteúdo Flutuante</h3>
            <p className="text-green-800 text-sm">Sidebars, floats e elementos fixos são consolidados no fluxo principal de conteúdo.</p>
          </div>
        </div>
      </section>
