export default function MobilidadeContent() {
  return (
    <div className="space-y-10">
      <header className="border-b-2 border-sky-200 pb-8">
      ...
      <section className="space-y-5">
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Acessível via Teclado</h3>
            <p className="text-green-800 text-sm leading-relaxed">Cada elemento interativo pode ser alcançado com Tab e ativado com Enter/Espaço.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Indicador de Foco Visível</h3>
            <p className="text-green-800 text-sm leading-relaxed">Um contorno claro e visível aparece ao redor do elemento em foco.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Grandes Áreas Clicáveis</h3>
            <p className="text-green-800 text-sm leading-relaxed">Botões e alvos são de no mínimo 44x44px para facilitar a interação.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded">
            <h3 className="font-bold text-green-900 mb-3">Sem Interações Cronometradas</h3>
            <p className="text-green-800 text-sm leading-relaxed">Não há conteúdo que exija uma reação rápida ou timing específico.</p>
          </div>
        </div>
      </section>
