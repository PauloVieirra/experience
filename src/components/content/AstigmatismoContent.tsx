export default function AstigmatismoContent() {
  return (
    <div className="space-y-8">
      <header className="border-b-2 border-yellow-200 pb-6">
      ...
      <section className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Fontes Claras e Pesadas</h3>
            <p className="text-green-800 text-sm">Usamos fontes com peso de 500 ou superior, bem definidas e fáceis de ler em todas as tamanhos.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Alto Contraste</h3>
            <p className="text-green-800 text-sm">Aumentamos o contraste entre o texto e o fundo para tornar as letras mais nítidas e legíveis.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Sem Efeitos Disruptivos</h3>
            <p className="text-green-800 text-sm">Removemos quaisquer efeitos de sombra, brilho ou desfoque que possam afetar a legibilidade.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Espaçamento Generoso</h3>
            <p className="text-green-800 text-sm">Aumentamos o espaço entre linhas e letras para melhorar a clareza visual e reduzir fadiga ocular.</p>
          </div>
        </div>
      </section>
