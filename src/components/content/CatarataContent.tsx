export default function CatarataContent() {
  return (
    <div className="space-y-8">
      <header className="border-b-2 border-blue-200 pb-6">
      ...
      <section className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Contraste Elevado</h3>
            <p className="text-green-800 text-sm">Aumentamos drasticamente o contraste. Texto preto sobre fundo branco é o padrão mais eficaz.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Fontes Maiores e Nítidas</h3>
            <p className="text-green-800 text-sm">Tamanho de fonte é aumentado (18px+) e usamos estilos que são claros e bem definidos.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Cores Vivas</h3>
            <p className="text-green-800 text-sm">Quando cores são usadas, elas são vibrantes e bem diferenciadas para evitar aparência lavada.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <h3 className="font-bold text-green-900 mb-2">Possibilidade de Ampliação</h3>
            <p className="text-green-800 text-sm">O conteúdo é responsivo e permitindo até 200% de zoom sem perda de funcionalidade.</p>
          </div>
        </div>
      </section>
