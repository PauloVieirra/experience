...
const disability: Disability = {
  id: 'acessibilidade-social',
  name: 'Acessibilidade Social',
  description: 'Linguagem clara, inclusão para todos os níveis de letramento.',
  icon: BookText,
  color: 'bg-indigo-100 text-indigo-600',
  locked: false,
};

export default function AcessibilidadeSocialModule({ handleModuleClick }: { handleModuleClick: (disability: Disability) => void }) {
